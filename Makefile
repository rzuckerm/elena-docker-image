ELENA_VERSION := $(shell cat ELENA_VERSION)
ELENA_DEPS := $(wildcard ELENA_*)
DOCKER_TAG_PREFIX := rzuckerm/elena:$(ELENA_VERSION)
...
$(META_BUILD_TARGET): Dockerfile Makefile $(ELENA_DEPS)
